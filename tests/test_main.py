...
#     res = decrypt(Config().library_default().set_verbosity(3).complete_config(),
...
def test_binary():
    res = decrypt(Config().library_default().complete_config(),
                  ...
                  "01100101 00100000 01100001 01101110 01100100 00100000 01110100 01110010 01100101 0110010")
